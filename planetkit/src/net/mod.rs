...
impl<G: GameMessage> Default for RecvMessageQueue<G> {
    fn default() -> RecvMessageQueue<G> {
        RecvMessageQueue {
...
impl<G: GameMessage> Default for SendMessageQueue<G> {
    fn default() -> SendMessageQueue<G> {
        SendMessageQueue {
